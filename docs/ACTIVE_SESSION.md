...
- New: whether/how to adapt `lirk`'s test-execution model (or this
  repo's import style) to reconcile the mismatch found above — deferred
  to the `lirk` repo, not this one.
